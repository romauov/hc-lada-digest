...
Форматируй ответ в HTML для Telegram. Используй <b> для жирного, <i> для курсива.
Не используй markdown (**, ```, []()), не используй <ul>, <li>, <p>, <pre>.
Ссылки оформляй как <a href="URL">текст</a>.
Для списков используй обычный дефис (-) и перевод строки."""
