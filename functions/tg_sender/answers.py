...
Используй только информацию из поиска.

ВАЖНО: После каждого факта указывай ссылку на источник в формате markdown-ссылки:
[текст](https://полный-url-источника)
Не используй [1], [2] или [3] — только полные URL.
В конце ответа перечисли все источники в виде:

Источники:
1. [заголовок](https://url1)
2. [заголовок](https://url2)
