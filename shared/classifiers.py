...
CLASSIFY_SYSTEM = (
    ...
    "\n"
    "Ниже перечислены сущности, которые есть в графе знаний бота.\n"
    "Если вопрос упоминает сущность, которой НЕТ в списке — нужен поиск (YES),\n"
    "потому что граф не может ответить о неизвестных ему сущностях.\n"
    "\n"
    "YES — нужен поиск:\n"
    ...
    "  • вопрос упоминает сущность, которой нет в списке\n"
    "\n"
    "NO — поиск не нужен:\n"
    "  • фактологический вопрос о сущности из списка (кто тренер, где арена)\n"
...
def classify_need_search(question: str, history: str, entities: Optional[dict] = None) -> bool:
